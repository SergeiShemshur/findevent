    ...
    <div class="row ">
        ...
        <div class="col-md-3">
            <div class="main">
                <div class="one">
                    <div class="register">
                        <h3>Input email and password</h3>
                        <%--    <form id="reg-form">--%>

                        <form role="form" action="/login" method="post">
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                            <div class="form-group">
                                <p for="InputEmail1" class="text-center">Email address</label>
                                <input type="email" name="email" id="email" class="form-control" id="InputEmail1" required autofocus
                                       placeholder="Email">
                            </div>

                            <div class="form-group">
                                <p for="InputPassword1" class="text-center">Password</p>
                                <input type="password" style="width: 100%" name="password" class="form-control" id="InputPassword1" required autofocus
                                       placeholder="Password">
                            </div>
